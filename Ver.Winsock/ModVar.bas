...
Public Placard(0 To 3, 1 To 14) As String '각 플레이어의 판
Public i As Integer, j As Integer, k As Integer, num As Integer '일반적 사용 변수
Public CardBool(0 To 25) As Boolean '카드가 이미 뽑혔는지 여부
Public TheAnswerCo As String '클릭시 정답
Public AnswerClickIndex As Integer '클릭한 위치
...
Public MyNum As Integer 'Winsock용 Player Number
Public PlayerNum As Integer '전체 플레이어 수
Public TurnPage As String 'Turn 차례
